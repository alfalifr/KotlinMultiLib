...
object Constants {
    ...
    val API_KEY = "afa01"//BuildConfig.SIGUDANG_API_KEY
    val CLIENT_ID = "client" //BuildConfig.SERVER_CLIENT_ID
    val CLIENT_SECRET = "cli-secret" //BuildConfig.SERVER_CLIENT_SECRET
    ...
    val EXTRA_CROSSDOCKING= "EXTRA_CROSSDOCKING" //BoundOverviewFrag_Cross_Abs.EXTRA_CROSSDOCKING
...
//        val OUTBOUND_MANAGED_AND_SHIPPED= 8 //--> Scan, Finished
        ...
        //        val CROSSDOCKING_ARRIVED= 121 //--> Tinggal mencemt
...
//        val CROSSDOCKING_MANAGED_AND_SHIPPED= 13 //--> Tinggal mencet
    ...
    object Presenter {
        ...
        val REQ_PAYMENT_METHODS = "payment_methods"
        val REQ_CREATE_ORDER_PRE_DATA = "create_order_pre_data"
        val REQ_SEND_SHIPPING_METHOD = "send_shipping_type"
        val REQ_PROC_INBOUND_CREATE_ORDER = "send_inbound_create_order"
        ...
        val REQ_PROC_OUTBOUND_CREATE_ORDER = "send_outbound_create_order"
        val REQ_PROC_OUTBOUND_CONFIRM = "outbound_confirm"
        ...
        val DATA_CREATE_ORDER_PRODUCT_LIST = "create_order_product_list"
        val DATA_CREATE_ORDER_WAREHOUSE_LIST = "create_order_warehouse_list"
        val DATA_CREATE_ORDER_SHIPPING_METHODS = "create_order_shipping_methods"
        val DATA_CREATE_ORDER_PACKAGING_TYEPS = "create_order_packaging_types"
        val DATA_PROC_INBOUND_CONFIRM = "data_inbound_confirm"
        val DATA_PROC_OUTBOUND_CONFIRM = "data_outbound_confirm"
        ...
        val DATA_PAYMENT_METHODS = "data_payment_methods"
