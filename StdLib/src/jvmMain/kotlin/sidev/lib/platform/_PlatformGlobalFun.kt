...
@Deprecated(
    "putInternalObjectOnGlobal() pada jvm pada langsung dideklarasikan pada Static Object",
    ReplaceWith("throw IllegalStateException(\"Fungsi getInternalObject() tidak tersedia di JVM.\")")
)
internal actual fun getInternalObject(name: String): Any = throw IllegalStateException("Fungsi getInternalObject() tidak tersedia di JVM.")