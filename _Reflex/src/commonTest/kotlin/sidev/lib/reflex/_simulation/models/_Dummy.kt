package com.sigudang.android._Dummy
...
import sidev.lib.reflex._simulation.models.Constants
...
val sendKindModel_list_thirdParty= arrayOf(
    SendMethodModel("Gosend", PictModel(resId = 12)),
    SendMethodModel("SiCepat", PictModel(resId = 13)),
    SendMethodModel("JNE", PictModel(resId = 14)),
    SendMethodModel("J&T", PictModel(resId = 15)),
    SendMethodModel("Pos Indonesia", PictModel(resId = 16)),
    SendMethodModel("Anteraja", PictModel(resId = 17))
)
...
val productList_full= arrayOf(
    Product("id1", "Asidas", categoryProductList[0], unitProductList[0], 2.2, 1.3, 2.3, PictModel(resId = 14)), //R.drawable.img_product_1
    Product("id2", "How to be a happy single-ton", categoryProductList[1], unitProductList[0], 5.2, 2.3, 1.2, PictModel(resId = 11)), //R.drawable.img_product_2
    Product("id3", "Everything will meet their couple", categoryProductList[0], unitProductList[0], 3.1, 3.2, 1.1, PictModel(resId = 10)), //R.drawable.img_product_2
    Product("id4", "Pepsiden", categoryProductList[2], unitProductList[0], 8.1, 1.2, 3.1, PictModel(resId = 12)), //R.drawable.img_product_3
    Product("id5", "Cap Ikan Gatol", categoryProductList[3], unitProductList[1], 11.1, 6.5, 3.1, PictModel(resId = 9)), //R.drawable.img_product_3
    Product("id6", "Kecap Oreng", categoryProductList[4], unitProductList[2], 3.1, 5.1, 1.3, PictModel(resId = 15)), //R.drawable.img_product_3
    Product("id7", "Kunci", categoryProductList[6], unitProductList[3], 1.1, 3.1, 4.1, PictModel(resId = 9)), //R.drawable.img_product_3
    Product("id8", "Minyak", categoryProductList[4], unitProductList[2], 3.1, 4.1, 5.4, PictModel(resId = 5)), //R.drawable.img_product_2
    Product("id9", "Gula", categoryProductList[5], unitProductList[2], 3.1, 3.1, 4.1, PictModel(resId = 3)), //R.drawable.img_product_1
    Product("id10", "Sayangku", categoryProductList[4], unitProductList[2], 3.1, 1.1, 3.1, PictModel(resId = 7)) //R.drawable.img_product_2
)
...
val bound_new= Bound(0, "id", "",
    productList = ArrayList(),//boundProductLisft_full.toCollection(ArrayList())
    shipper = ShipperModel("", ""),
    send = BoundSendModel(ReceiptModel(""), method = SendMethodModel("", null))
)
